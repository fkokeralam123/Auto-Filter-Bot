        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("HELP", callback_data="help_data"),
                    InlineKeyboardButton("GROUP", url="https://t.me/Movie_Collections_Group")],
                [InlineKeyboardButton("⭕️JOIN OUR CHANNEL ⭕️", url="https://t.me/Movie_Collections_channel")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ OWNER ⭕️", url="https://t.me/unknown_usernam0")]
            ])
